              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                ...
                <form className="mt-3 sm:flex">
                  ...
                  <input
                    ...
                    id="email"
                    required
                    className="block w-full py-3 text-base rounded-md dark:bg-dark-main dark:border-dark-second dark:text-dark-txt placeholder-gray-500 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:flex-1 border-gray-300"
